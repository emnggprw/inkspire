  ...
  Future<void> generateImage() async {
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          "prompt": prompt, // User's description for the image
          "model": "realvisxl", // Image generation model
          "aspectRatio": "square", // Aspect ratio of the image
          "highResolution": false,
          "images": 1, // Number of images to generate
          "steps": 20, // Steps for image generation
